...
localStorage.setItem("ID_participante", "1");
localStorage.setItem("nombre_participante", "Tania Naal");
localStorage.setItem("fecha", "27/12/2021");
localStorage.setItem("dias_inscripcion", "10");

console.log(localStorage.getItem("ID_participante"));
console.log(localStorage.getItem("nombre_participante"));
console.log(localStorage.getItem("fecha"));
console.log(localStorage.getItem("dias_inscripcion"));